...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-genealogy-discovery-filament?sort=semver)](https://github.com/liberusoftware/module-genealogy-discovery-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-genealogy-discovery-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-genealogy-discovery-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-genealogy-discovery-filament
```
...
<a href="https://github.com/liberusoftware/module-genealogy-discovery-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-genealogy-discovery-filament" alt="Contributors to liberusoftware/module-genealogy-discovery-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-genealogy-discovery-filament/graphs/contributors).
